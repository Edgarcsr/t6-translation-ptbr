          ...
          {onPick && (
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  onClick={onPick}
                  className="w-5 h-5 rounded flex items-center justify-center bg-neutral-800 hover:bg-neutral-700 text-neutral-500 hover:text-neutral-300 transition-all flex-shrink-0"
                >
